//
//  DCollectionViewSectionBackgroundLayout.swift
//  YYQ-Swift
//
...
private let SectionBackground = "DCollectionReusableView"

protocol DCollectionViewSectionBackgroundLayoutDelegateLayout: UICollectionViewDelegateFlowLayout {
    func collectionView(_ collectionView: UICollectionView,
                        layout collectionViewLayout: UICollectionViewLayout,
                        backgroundColorForSectionAt section: Int) -> UIColor
}

extension DCollectionViewSectionBackgroundLayoutDelegateLayout {
    func collectionView(_ collectionView: UICollectionView,
                        layout collectionViewLayout: UICollectionViewLayout,
                        backgroundColorForSectionAt section: Int) -> UIColor {
...
private class DCollectionViewLayoutAttributes: UICollectionViewLayoutAttributes {
    var backgroundColor = UIColor.white
    
    override func copy(with zone: NSZone? = nil) -> Any {
        let copy = super.copy(with: zone) as! DCollectionViewLayoutAttributes
        copy.backgroundColor = self.backgroundColor
        return copy
    }
    
    override func isEqual(_ object: Any?) -> Bool {
        guard let rhs = object as? DCollectionViewLayoutAttributes else {
            return false
        }
...
private class DCollectionReusableView: UICollectionReusableView {
    
    override func apply(_ layoutAttributes: UICollectionViewLayoutAttributes) {
        super.apply(layoutAttributes)
        
        guard let attr = layoutAttributes as? DCollectionViewLayoutAttributes else {
            return
        }
...
class DCollectionViewSectionBackgroundLayout: UICollectionViewFlowLayout {
    ...
    func setup() {
        self.register(DCollectionReusableView.classForCoder(), forDecorationViewOfKind: SectionBackground)
    }
    ...
    override func prepare() {
        ...
        guard let numberOfSections = self.collectionView?.numberOfSections,
            let delegate = self.collectionView?.delegate as? DCollectionViewSectionBackgroundLayoutDelegateLayout
            else {
                return
        }
        ...
        for section in 0..<numberOfSections {
            ...
            let attr = DCollectionViewLayoutAttributes(forDecorationViewOfKind: SectionBackground, with: IndexPath(item: 0, section: section))
