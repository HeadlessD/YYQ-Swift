...
let timeoutClosure = {(endpoint: Endpoint, closure: MoyaProvider<DApi>.RequestResultClosure) -> Void in
...
let ApiProvider = MoyaProvider<DApi>(requestClosure: timeoutClosure)
let ApiLoadingProvider = MoyaProvider<DApi>(requestClosure: timeoutClosure, plugins: [LoadingPlugin])
